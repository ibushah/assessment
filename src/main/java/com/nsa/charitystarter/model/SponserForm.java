...
public class SponserForm {
    ...
    public SponserForm(String fundraiserName, Long charityId, String fundraisingAction, Date dateCreated, Date firstValidDate, Date lastValidDate, String furl) {
